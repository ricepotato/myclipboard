      ...
      <div>
        ...
        <div>
          ...
          <input
            ...
            type="text"
            name="data"
            className="w-full h-12 px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
          />
        </div>
      </div>
